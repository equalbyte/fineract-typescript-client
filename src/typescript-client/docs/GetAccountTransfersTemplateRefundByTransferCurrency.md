...
```typescript
import { GetAccountTransfersTemplateRefundByTransferCurrency } from 'fineract-typescript-client';

const instance: GetAccountTransfersTemplateRefundByTransferCurrency = {
    code,
    decimalPlaces,
    displayLabel,
    displaySymbol,

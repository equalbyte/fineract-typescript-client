...
**transactions** | [**Array&lt;InteropTransactionData&gt;**](InteropTransactionData.md) |  | [optional] [default to undefined]

## Example

```typescript
import { InteropTransactionsData } from 'fineract-typescript-client';

const instance: InteropTransactionsData = {
    changes,
    clientId,
    commandId,

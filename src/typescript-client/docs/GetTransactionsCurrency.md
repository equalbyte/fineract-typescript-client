...
**isMultiplesOf** | **number** |  | [optional] [default to undefined]
...
```typescript
import { GetTransactionsCurrency } from 'fineract-typescript-client';

const instance: GetTransactionsCurrency = {
    code,
    decimalPlaces,
    displayLabel,
    displaySymbol,
